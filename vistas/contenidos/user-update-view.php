...
<div class="container-fluid">
    ...
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off" >
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="usuario_cargo_up" id="usuario_cargo">
                                <?php
                                    $array_cargo=["Administrador","Usuario"];
        ...
        <br><br><br>
        <fieldset>
            <legend><i class="fas fa-eye"></i> &nbsp; Tipo de Rool de Asignado</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <?php
                                $datos_caja=$lc->datos_tabla("Normal","usuario","*",0);
                                while($campos_caja=$datos_caja->fetch()){
                                    if($campos_caja['usuario_id']==$campos['usuario_id']){
                                        echo '<option value="'.$campos_caja['usuario_id'].'" selected="" >Tipo de rool. '.$campos_caja['usuario_nombre'].' - '.$campos_caja['usuario_cargo'].' (Actual)</option>';
                                    }else{
