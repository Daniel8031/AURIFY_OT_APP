...
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="save" autocomplete="off" >
        ...
        <fieldset>
            ...
            <legend><i class="fas fa-id-card"></i> &nbsp; Permisos del Nuevo Usuario</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <select class="form-control" name="usuario_caja_reg">
                                <option value="" selected="" >Seleccione una opción</option>
                                <?php
                                    $datos_caja=$lc->datos_tabla("Normal","rol","*",0);

                                    while($campos_caja=$datos_caja->fetch()){
                                        if($campos_caja['rol_estado']=="Habilitada"){
                                            echo '<option value="'.$campos_caja['rol_id'].'">Opcion No.'.$campos_caja['rol_numero'].' ('.$campos_caja['rol_nombre'].')</option>';
                                        }
                                    }
                                ?>
                            </select>
