    ...
    <div class="full-box nav-lateral-content scroll">
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                    <a href="#" class="nav-btn-submenu"><i class="fas fa-gamepad fa-fw"></i> &nbsp; Games <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <?php if($_SESSION['cargo_svi']=="Administrador"){ ?>
                            <li>
                ...
                <li>
                    <a href="#" class="nav-btn-submenu"><i class="fas fa-history fa-fw"></i> &nbsp; Historial <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <li>
